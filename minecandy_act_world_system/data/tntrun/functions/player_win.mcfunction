schedule clear tntrun:game_playing
...
tellraw @a[tag=tntrun_join_game] [{"text":"【","color":"dark_red","bold":true},{"text":"TNTRUN系統","color":"red","bold":true},{"text":"】","color":"dark_red","bold":true},{"selector":"@s"},{"text":"以第","bold":true,"color":"yellow"},{"score":{"name":"@s","objective":"tntrun_player_rank"}},{"text":"名獲勝!","bold":true,"color":"yellow"}]
title @s title {"text":"你獲勝了","bold":true,"color":"yellow"}
