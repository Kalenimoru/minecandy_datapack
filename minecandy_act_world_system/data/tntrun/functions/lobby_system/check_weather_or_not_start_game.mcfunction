...
execute if score 遊戲系統狀態 tntrun.system_state matches 0 unless entity @a[predicate=!tntrun:is_sneaking,scores={tntrun.join=1}] as @r[predicate=tntrun:is_sneaking,scores={tntrun.join=1}] run function tntrun:game_starting/initialize_the_game
